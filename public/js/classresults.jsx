...
class WowFormInputForm extends React.Component {
  ...
  render() {
          ...
          <span className="results-table--feedback-inputs">
            <div style={{textAlign: 'center'}}>
              <span style={{opacity: 1.0, color: 'white'}} className="results-table--feedback-thanks">
                <em className="base--em">Gracias</em>
              </span>
            </div>
          </span>
        </td>
    ...
    return (<tr style={baseStyle} className="base--tr">
      ...
      <label><em className="base--em">¿Te sorprendimos?</em></label>
      ...
      <label htmlFor={this.props.name +'-yes'} className="base--inline-label results-table--input-yes-label">Sí</label>
      <input role="radio"
             onChange={this.handleChange.bind(this)}
...
class ScoreTableHeader extends React.Component {
  render() {
    ...
    <tr className="base--tr">
      ...
      <th className="base--th results-table--header">Puntaje</th>
    </tr>
    </thead>);
  }
}
  ...
  render() {
    if (this.props.items && this.props.items.length === 0) {
        return (<div className="use--mismatch">
          {"No reconozco que es un DNI. Por favor, intente de nuevo."}</div>);
    }
    return (
...
class ClassifyScoreTable extends React.Component {
  render() {
    if (this.props.items && this.props.items.length === 0) {
        return (<div className="use--mismatch">
          No se parece a ningún personaje. Por favor, intenta de nuevo.</div>);
      }
    return (
        <div className="results-table--container">
          <JsonLink rawjson={this.props.rawjson}/>
...
class CustomResultsTable extends React.Component {
  render() {
    return (<div className="use--output-data">
        ...
        <form action="http://juradocosplays.mybluemix.net/form" method="post" id="form" >
        </form>
    );
  }
}
