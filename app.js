...
var visualRecognition = new watson.VisualRecognitionV3({
    api_key: process.env.API_KEY || 'ca11c573923c880f5f4b8d0a244c7d6ebc79fd1c',
...
app.post('/api/classify', app.upload.single('images_file'), function(req, res) {
    ...
    if (req.body.classifier_id || process.env.OVERRIDE_CLASSIFIER_ID) {
        ...
        params.classifier_ids = ['LeagueofLegendsCosplay_1253641275', 'food'];
        params.threshold = 0.1; //So the classifers only show images with a confindence level of 0.5 or higher
        methods.push('classify');
